...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EventNest — Find Wedding & Event Venues" },
      { name: "description", content: "Discover convention halls, wedding venues, and banquet spaces across Andhra Pradesh and Telangana." },
